...
def printYieldsPlusUncertaintiesOneLine(SRid,centralYield,centralError,centralUp, centralDown):
    name = ""
...
def printYieldsPlusUncertainties(centralYield,centralError,centralUp, centralDown,systematics,sample):
    print("Tested systematics: " + systematics + " for sample " + sample)
    print(printYieldsPlusUncertaintiesOneLine( 0,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 1,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 2,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 3,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 4,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 5,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 6,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 7,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 8,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine( 9,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine(10,centralYield,centralError,centralUp, centralDown))
    print(printYieldsPlusUncertaintiesOneLine(11,centralYield,centralError,centralUp, centralDown))
...
def getSystUncertainty(sample,systematics,theyear=-1):
    ...
    printYieldsPlusUncertainties(centralYield,centralError,centralUp, centralDown,systematics,sample)
    return True
