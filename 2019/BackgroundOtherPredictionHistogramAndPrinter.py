...
def LoadWZprediction(histos):
    fWZ = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/mastersyst/PredictionHistogramsForWZbkg.root")
...
def LoadFakeprediction(histos):
    fFake = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/mastersyst/PredictionHistogramsForFakebkg.root")
...
def LoadQFlipprediction(histos):
    fQ = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/master/PredictionHistogramsForQFlipbkg.root")
...
def LoadPromptttWprediction(histos):
    fttW = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/master/PredictionHistogramsForttWbkg.root")
...
def LoadPromptVBSprediction(histos):
    fvbs = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/master/PredictionHistogramsForVBSbkg.root")
...
def LoadPhotonFakesprediction(histos):
    fG = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/master/PredictionHistogramsForPhotonFakebkg.root")
...
def LoadSignalPredictions(histos,signalid="WWW"):
    fsig = ROOT.TFile.Open("hists/combineyearsLoose_v5.3.2/mastersigsyst/PredictionHistogramsFor"+signalid+".root")
...
def MakePhotonFakePrediction():
    mydir = getpath(short=True,year=-1)
    TF2016,TF2016err, TF2017,TF2017err, TF2018,TF2018err = 0.885,0.060, 0.525,0.024, 0.514,0.020
...
def MakeFinalTable(histos,wide=False):
    tablestring = \
    "\\begin{table}[htb]\n" + \
    "\\centering\n" + \
...
def PrintPredictions():
    ...
    MakeFinalTable(histos,False)
    MakeFinalTable(histos,True)
