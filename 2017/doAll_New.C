{
  ...
  myhelper = babylocation + "Wpjj_lnu_madgraph*.root";                  ch[6]->Add(myhelper.c_str());
  myhelper = babylocation + "Wmjj_lnu_madgraph*.root";                  ch[6]->Add(myhelper.c_str());
  ...
  myhelper = babylocation + "Zjj_m50_madgraph*.root";                   ch[7]->Add(myhelper.c_str());
  ...
  //myhelper = babylocation2 + "wpwpjj_ewk-qcd_madgraph*.root";           ch[8]->Add(myhelper.c_str());
  //myhelper = babylocation2 + "wmwm_powheg*.root";                       ch[8]->Add(myhelper.c_str());
