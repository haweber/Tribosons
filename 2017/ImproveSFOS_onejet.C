...
int ScanChain( TChain* chain, bool fast = true, int nEvents = -1, string skimFilePrefix = "test", int chainnumber=1) {
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	if(gen_ht()>100) continue;
      ...
      if(weight>80) { cout << weight << " " << currentFile->GetTitle() << endl; continue; }
      if(isData()) weight = 1.;
	...
	weight *= PUweight;
      ...
      int nj(0), nb(0), nj30(0), njsoft20(0);
	...
	if(   jets_p4()[n].Pt()>=20&&fabs(   jets_p4()[n].Eta())<=2.4&&   jets_csv()[n]>=0.5426) ++nb;
      }
      float Mjj = 80;
      float MjjL = 80; float Detajj = 0.1;
	...
	MTs.push_back(mT(lep_p4()[i3l[i] ],MET));
     ...
     sort(MTs.begin(),MTs.end(),sortDecreasing);
      ...
      int CR3lpresel = -1;
      //SS
      SRSSpresel = isSRSS(iSS,      vSS,true ,MTmax,  2,nb,Mjj,MjjL,Detajj,MET,0,false,false,1);//enter variables for quicker calculation
      if(nj30>=2) SRSSpresel = -1;
      if(nj30<1) SRSSpresel = -1;
      //cout << __LINE__ << endl;
      //3l
      ...
      if(vetophotonprocess(fname,isphoton3l))    { SR3lpresel = -1; SR3l = -1; }
	...
	if(!isData()||!blindSR){
	  ...
	  if(SRSSpresel==0) passMET = (met_pt()>60.);//ee
	  ...
	  for(unsigned int n = 0; n<jets_p4().size();++n){
	    if(!(   jets_p4()[n].Pt()>=30&&fabs(   jets_p4()[n].Eta())<=2.4)) continue;
	    ...
	    if(dPhi(jets_p4()[n],lep_p4()[iSS[0] ])<minDRlj) minDPhilj = dPhi(jets_p4()[n],lep_p4()[iSS[0] ]);
	    if(dPhi(jets_p4()[n],lep_p4()[iSS[1] ])<minDRlj) minDPhilj = dPhi(jets_p4()[n],lep_p4()[iSS[1] ]);
	    MTjjllMET = mT(jets_p4()[n],MET);
	    /*
	    for(unsigned int m = n+1; m<jets_p4().size();++m){
	      if(!(   jets_p4()[m].Pt()>=20&&fabs(   jets_p4()[m].Eta())<=3.0)) continue;
	  ...
	  if(passMjj&&passMjjL&&passDeta&&passMll&&passMET&&passMT) {
	    ...
	    if((lep_p4()[iSS[0] ]+lep_p4()[iSS[1] ]).M()>40.) fillhisto(histos, "SR_addone",     mysample, mysn, 5.,      weight);//Mll
	    if((lep_p4()[iSS[0] ]+lep_p4()[iSS[1] ]).M()>60.) fillhisto(histos, "SR_addone",     mysample, mysn, 6.,      weight);//Mll
	    if((lep_p4()[iSS[0] ]+lep_p4()[iSS[1] ]).M()>80.) fillhisto(histos, "SR_addone",     mysample, mysn, 7.,      weight);//Mll
	    if(MTs[0]>120.)                                   fillhisto(histos, "SR_addone",     mysample, mysn, 8.,      weight);//MTmax
	    if(MTs[1]>90.)                                    fillhisto(histos, "SR_addone",     mysample, mysn, 9.,      weight);//MTmin
	    if(met_pt()>80.)                                  fillhisto(histos, "SR_addone",     mysample, mysn,10.,      weight);//MET
	    if(met_pt()>100.)                                 fillhisto(histos, "SR_addone",     mysample, mysn,11.,      weight);//MET
	    if(met_pt()/(lep_p4()[iSS[0] ]+lep_p4()[iSS[1] ]).Pt()>0.5) fillhisto(histos, "SR_addone",     mysample, mysn,12.,      weight);//MET/pTll
	    if((MTs[0]+MTs[1])>200.)                          fillhisto(histos, "SR_addone",     mysample, mysn,13.,      weight);//MTsum
	    ...
	    if(met_pt()>60.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone",     mysample, mysn,19.,      weight);//minDRlj
	    if(met_pt()>60.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone",     mysample, mysn,20.,      weight);//minDPhilj
	    if(met_pt()>60.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone",     mysample, mysn,21.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone",     mysample, mysn,22.,      weight);//minDRlj
	    if(met_pt()>80.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone",     mysample, mysn,23.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone",     mysample, mysn,24.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDRlj<1.5)                        fillhisto(histos, "SR_addone",     mysample, mysn,25.,      weight);//minDRlj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5)                      fillhisto(histos, "SR_addone",     mysample, mysn,26.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5&&minDPhilj>0.5)       fillhisto(histos, "SR_addone",     mysample, mysn,27.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone",     mysample, mysn,28.,      weight);//minDRlj
	    if(MTs[0]>90.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone",     mysample, mysn,29.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone",     mysample, mysn,30.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone",     mysample, mysn,31.,      weight);//minDRlj
	    if(MTs[1]>50.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone",     mysample, mysn,32.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone",     mysample, mysn,33.,      weight);//minDPhilj
	    if(met_pt()>60.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone",     mysample, mysn,44.,      weight);//
	    if(met_pt()>60.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone",     mysample, mysn,34.,      weight);//
	    if(met_pt()>60.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone",     mysample, mysn,35.,      weight);//
	    if(met_pt()>80.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone",     mysample, mysn,36.,      weight);//
	    if(met_pt()>80.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone",     mysample, mysn,37.,      weight);//
	    if(met_pt()>80.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone",     mysample, mysn,38.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone",     mysample, mysn,39.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone",     mysample, mysn,40.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone",     mysample, mysn,41.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone",     mysample, mysn,42.,      weight);//
	    if(MTs[0]>150.)                                   fillhisto(histos, "SR_addone",     mysample, mysn, 43.,      weight);//MTmax
	  ...
	  if(passMjj&&passMjjL&&passDeta&&passMll         &&passMT){
	    ...
	    if(met_pt()>60.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,19.,      weight);//minDRlj
	    if(met_pt()>60.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,20.,      weight);//minDPhilj
	    if(met_pt()>60.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,21.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,22.,      weight);//minDRlj
	    if(met_pt()>80.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,23.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,24.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDRlj<1.5)                        fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,25.,      weight);//minDRlj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5)                      fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,26.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5&&minDPhilj>0.5)       fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,27.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,28.,      weight);//minDRlj
	    if(MTs[0]>90.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,29.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,30.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,31.,      weight);//minDRlj
	    if(MTs[1]>50.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,32.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,33.,      weight);//minDPhilj
	    if(met_pt()>60.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,44.,      weight);//
	    if(met_pt()>60.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,34.,      weight);//
	    if(met_pt()>60.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,35.,      weight);//
	    if(met_pt()>80.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,36.,      weight);//
	    if(met_pt()>80.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,37.,      weight);//
	    if(met_pt()>80.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,38.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,39.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,40.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,41.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone_dropMET",     mysample, mysn,42.,      weight);//
	    if(MTs[0]>150.)                                   fillhisto(histos, "SR_addone_dropMET",     mysample, mysn, 43.,      weight);//MTmax
	  }
	  ...
	  if(SRSSpresel==1){
	    ...
	    if(met_pt()>60.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,19.,      weight);//minDRlj
	    if(met_pt()>60.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,20.,      weight);//minDPhilj
	    if(met_pt()>60.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,21.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDRlj<1.5)                               fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,22.,      weight);//minDRlj
	    if(met_pt()>80.&&minDPhilj<1.5)                             fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,23.,      weight);//minDPhilj
	    if(met_pt()>80.&&minDPhilj<1.5&&minDPhilj>0.5)              fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,24.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDRlj<1.5)                        fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,25.,      weight);//minDRlj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5)                      fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,26.,      weight);//minDPhilj
	    if((MTs[0]+MTs[1])>90.&&minDPhilj<1.5&&minDPhilj>0.5)       fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,27.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,28.,      weight);//minDRlj
	    if(MTs[0]>90.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,29.,      weight);//minDPhilj
	    if(MTs[0]>90.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,30.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDRlj<1.5)                                 fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,31.,      weight);//minDRlj
	    if(MTs[1]>50.&&minDPhilj<1.5)                               fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,32.,      weight);//minDPhilj
	    if(MTs[1]>50.&&minDPhilj<1.5&&minDPhilj>0.5)                fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,33.,      weight);//minDPhilj
	    if(met_pt()>60.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,44.,      weight);//
	    if(met_pt()>60.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,34.,      weight);//
	    if(met_pt()>60.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,35.,      weight);//
	    if(met_pt()>80.&&(MTs[0]+MTs[1])>90.)                       fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,36.,      weight);//
	    if(met_pt()>80.&&MTs[0]>90.)                                fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,37.,      weight);//
	    if(met_pt()>80.&&MTs[1]>50)                                 fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,38.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,39.,      weight);//
	    if(MTs[1]>50.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,40.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>90.)                                  fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,41.,      weight);//
	    if(MTs[1]>90.&&MTs[0]>120.)                                  fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn,42.,      weight);//
	    if(MTs[0]>150.)                                   fillhisto(histos, "SR_addone_dropMTmax",     mysample, mysn, 43.,      weight);//MTmax
	    }
	  }
  ...
  SaveHistosToFile("rootfiles/ImproveStuffv2NewBabe_onejet.root",histos,true,true,(chainnumber==0));
