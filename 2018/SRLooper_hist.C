...
int ScanChain( TChain* chain, bool fast = true, int nEvents = -1, string skimFilePrefix = "test", int chainnumber=1) {
  ...
  histonames.push_back("LepEtaMax_SR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("LepEtaMax_AR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("LepEtaMax_CR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("LepEtaMax_SRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("LepEtaMax_ARpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("LepEtaMax_CRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_SR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_AR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_CR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_SRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_ARpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("EleEtaMax_CRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_SR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_AR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_CR");                        hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_SRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_ARpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  histonames.push_back("MuoEtaMax_CRpresel");                  hbins.push_back(30); hlow.push_back(0); hup.push_back(15);
  map<string,vector< float> > binning;
  map<string, pair<vector<double>,vector<double> > > histos =  bookhistograms(binning,skimFilePrefix, histonames,hbins, hlow, hup, rootdir);
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	if(abs(lep_pdgId()[i])==11 && fabs(lep_etaSC()[i]   )>eleetamax) eleetamax = fabs(lep_etaSC()[i]);
	if(abs(lep_pdgId()[i])==13 && fabs(lep_p4()[i].Eta())>muoetamax) muoetamax = fabs(lep_p4()[i].Eta());
      }
      float lepetamax = std::max(muoetamax,eleetamax);
      if(!isData()||!blindSR){//SR is blinded
	if(SRSS[0]>=0)  fillhisto(  histos, binning, "LepEtaMax_SR"      , sample, sn, lepetamax+SRSS[0]*2.5,     weight);
	if(SR3l[0]>=0)  fillhisto(  histos, binning, "LepEtaMax_SR",       sample, sn, lepetamax+SR3l[0]*2.5+7.5, weight);
	if(SRSS[1]>=0)  fillhisto(  histos, binning, "LepEtaMax_SRpresel", sample, sn, lepetamax+SRSS[1]*2.5,     weight);
	if(SR3l[1]>=0)  fillhisto(  histos, binning, "LepEtaMax_SRpresel", sample, sn, lepetamax+SR3l[1]*2.5+7.5, weight);
	if(SRSS[0]>=0)  fillhisto(  histos, binning, "EleEtaMax_SR"      , sample, sn, eleetamax+SRSS[0]*2.5,     weight);
	if(SR3l[0]>=0)  fillhisto(  histos, binning, "EleEtaMax_SR",       sample, sn, eleetamax+SR3l[0]*2.5+7.5, weight);
	if(SRSS[1]>=0)  fillhisto(  histos, binning, "EleEtaMax_SRpresel", sample, sn, eleetamax+SRSS[1]*2.5,     weight);
	if(SR3l[1]>=0)  fillhisto(  histos, binning, "EleEtaMax_SRpresel", sample, sn, eleetamax+SR3l[1]*2.5+7.5, weight);
	if(SRSS[0]>=0)  fillhisto(  histos, binning, "MuoEtaMax_SR"      , sample, sn, muoetamax+SRSS[0]*2.5,     weight);
	if(SR3l[0]>=0)  fillhisto(  histos, binning, "MuoEtaMax_SR",       sample, sn, muoetamax+SR3l[0]*2.5+7.5, weight);
	if(SRSS[1]>=0)  fillhisto(  histos, binning, "MuoEtaMax_SRpresel", sample, sn, muoetamax+SRSS[1]*2.5,     weight);
	if(SR3l[1]>=0)  fillhisto(  histos, binning, "MuoEtaMax_SRpresel", sample, sn, muoetamax+SR3l[1]*2.5+7.5, weight);
      }
      if(  SRSS[2]>=0)  fillhisto(  histos, binning, "LepEtaMax_AR",       sample, sn, lepetamax+SRSS[2]*2.5,     weight);
      if(  SR3l[2]>=0)  fillhisto(  histos, binning, "LepEtaMax_AR",       sample, sn, lepetamax+SR3l[2]*2.5+7.5, weight);
      if(  SRSS[4]>=0)  fillhisto(  histos, binning, "LepEtaMax_CR",       sample, sn, lepetamax+SRSS[4]*2.5,     weight);
      if(  SR3l[4]>=0)  fillhisto(  histos, binning, "LepEtaMax_CR",       sample, sn, lepetamax+SR3l[4]*2.5+7.5, weight);
      if(  SRSS[3]>=0)  fillhisto(  histos, binning, "LepEtaMax_ARpresel", sample, sn, lepetamax+SRSS[3]*2.5,     weight);
      if(  SR3l[3]>=0)  fillhisto(  histos, binning, "LepEtaMax_ARpresel", sample, sn, lepetamax+SR3l[3]*2.5+7.5, weight);
      if(  SRSS[5]>=0)  fillhisto(  histos, binning, "LepEtaMax_CRpresel", sample, sn, lepetamax+SRSS[5]*2.5,     weight);
      if(  SR3l[5]>=0)  fillhisto(  histos, binning, "LepEtaMax_CRpresel", sample, sn, lepetamax+SR3l[5]*2.5+7.5, weight);
      if(  SRSS[2]>=0)  fillhisto(  histos, binning, "EleEtaMax_AR",       sample, sn, eleetamax+SRSS[2]*2.5,     weight);
      if(  SR3l[2]>=0)  fillhisto(  histos, binning, "EleEtaMax_AR",       sample, sn, eleetamax+SR3l[2]*2.5+7.5, weight);
      if(  SRSS[4]>=0)  fillhisto(  histos, binning, "EleEtaMax_CR",       sample, sn, eleetamax+SRSS[4]*2.5,     weight);
      if(  SR3l[4]>=0)  fillhisto(  histos, binning, "EleEtaMax_CR",       sample, sn, eleetamax+SR3l[4]*2.5+7.5, weight);
      if(  SRSS[3]>=0)  fillhisto(  histos, binning, "EleEtaMax_ARpresel", sample, sn, eleetamax+SRSS[3]*2.5,     weight);
      if(  SR3l[3]>=0)  fillhisto(  histos, binning, "EleEtaMax_ARpresel", sample, sn, eleetamax+SR3l[3]*2.5+7.5, weight);
      if(  SRSS[5]>=0)  fillhisto(  histos, binning, "EleEtaMax_CRpresel", sample, sn, eleetamax+SRSS[5]*2.5,     weight);
      if(  SR3l[5]>=0)  fillhisto(  histos, binning, "EleEtaMax_CRpresel", sample, sn, eleetamax+SR3l[5]*2.5+7.5, weight);
      if(  SRSS[2]>=0)  fillhisto(  histos, binning, "MuoEtaMax_AR",       sample, sn, muoetamax+SRSS[2]*2.5,     weight);
      if(  SR3l[2]>=0)  fillhisto(  histos, binning, "MuoEtaMax_AR",       sample, sn, muoetamax+SR3l[2]*2.5+7.5, weight);
      if(  SRSS[4]>=0)  fillhisto(  histos, binning, "MuoEtaMax_CR",       sample, sn, muoetamax+SRSS[4]*2.5,     weight);
      if(  SR3l[4]>=0)  fillhisto(  histos, binning, "MuoEtaMax_CR",       sample, sn, muoetamax+SR3l[4]*2.5+7.5, weight);
      if(  SRSS[3]>=0)  fillhisto(  histos, binning, "MuoEtaMax_ARpresel", sample, sn, muoetamax+SRSS[3]*2.5,     weight);
      if(  SR3l[3]>=0)  fillhisto(  histos, binning, "MuoEtaMax_ARpresel", sample, sn, muoetamax+SR3l[3]*2.5+7.5, weight);
      if(  SRSS[5]>=0)  fillhisto(  histos, binning, "MuoEtaMax_CRpresel", sample, sn, muoetamax+SRSS[5]*2.5,     weight);
      if(  SR3l[5]>=0)  fillhisto(  histos, binning, "MuoEtaMax_CRpresel", sample, sn, muoetamax+SR3l[5]*2.5+7.5, weight);
  ...
  SaveHistosToFile("rootfiles/SRLooper_hist.root",histos,binning,true,true,(chainnumber==0));
